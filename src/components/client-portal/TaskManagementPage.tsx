...
const order = {
  ...
  provider: {
    name: 'ProviderX',
    avatarUrl: 'https://i.pravatar.cc/150?u=providerx'
  },
  ...
  description:
    'Annual tax return preparation and filing for a single-member LLC. All financial statements will be provided.',
...
const finalDeliverables = [
  {
    name: 'Final_Tax_Return_2024.pdf',
    size: '1.5 MB',
    submittedAt: 'Oct 6, 9:29 AM'
  },
  {
    name: 'Filing_Confirmation.png',
    size: '300 KB',
    submittedAt: 'Oct 6, 9:29 AM'
  }
];
        ...
        return (
          <React.Fragment key={status}>
            <div className='flex flex-col items-center'>
              ...
              <p
                className={`mt-2 text-center text-xs ${isCurrent ? 'text-primary font-bold' : 'text-muted-foreground'}`}
              >
                {status.replace('_', ' ')}
              </p>
            </div>
            {index < statuses.length - 1 && (
              <div
                className={`mx-2 h-0.5 flex-1 ${isCompleted ? 'bg-primary' : 'bg-muted-foreground/20'}`}
              />
            )}
          </React.Fragment>
        );
...
const ChatMessage = ({ msg }: { msg: Message }) => {
  ...
  return (
    <div className={`flex items-start gap-3 ${isClient ? 'justify-end' : ''}`}>
      ...
      >
        <div
          className={`rounded-lg p-3 text-sm ${isClient ? 'bg-primary text-primary-foreground' : 'bg-muted'}`}
        >
          {msg.text && <p>{msg.text}</p>}
          {msg.file && (
            <a
              href='#'
              className='bg-background/50 hover:bg-background/80 mt-2 flex items-center gap-3 rounded-md p-2'
            >
...
export default function TaskManagementPage() {
  return (
    <div className='bg-muted/40 flex min-h-screen w-full flex-col'>
      <header className='bg-background sticky top-0 z-30 flex h-16 items-center gap-4 border-b px-4 sm:px-6'>
          ...
          <div className='space-y-6 lg:col-span-2'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Provider: {order.provider.name} | Price: ${order.price} (in
                  Escrow) | Due: {order.dueDate}
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Tabs defaultValue='messages' className='w-full'>
              ...
              <TabsContent value='deliverables'>
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Files submitted by the provider for your final approval.
                    </CardDescription>
                  </CardHeader>
                      ...
                      >
                        <div>
                          ...
                          <p className='text-muted-foreground text-sm'>
                            {file.size} - Submitted: {file.submittedAt}
                          </p>
                        </div>
              ...
              <TabsContent value='details'>
                <Card>
                  <CardHeader>
                    <CardTitle>Original Job Request</CardTitle>
                  </CardHeader>
            ...
            <Card>
              ...
              <CardContent className='space-y-4'>
                  ...
                  <>
                    <Alert>
                      ...
                      <AlertDescription className='mb-4'>
                        The provider has submitted the final work. Please review
                        the files in the "Deliverables" tab.
                      </AlertDescription>
                    </Alert>
                ...
                {order.status === 'IN_PROGRESS' && (
                  ...
                  >
                    ...
                    <AlertDescription className='text-blue-700'>
                      The provider is currently working on your order.
                    </AlertDescription>
                  </Alert>
                )}
                <Separator />
                <div className='space-y-2'>
                  ...
                  <Button
                    variant='outline'
                    className='text-destructive hover:text-destructive hover:bg-destructive/5 w-full justify-start'
                  >
